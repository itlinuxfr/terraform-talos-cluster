...
|------|-------------|:---------:|
| <a name="output_kubeconfig"></a> [kubeconfig](#output\_kubeconfig) | Raw Kubeconfig data | yes |
| <a name="output_kubeconfig_client_configuration"></a> [kubeconfig\_client\_configuration](#output\_kubeconfig\_client\_configuration) | Kubernetes client configuration | yes |
| <a name="output_talosconfig"></a> [talosconfig](#output\_talosconfig) | Talos client configuration | yes |
<!-- END_TF_DOCS -->
